// Versione con Modal scorrevole, note modificabili e toggle "Completato"
        ...
        <div className="p-6 overflow-y-auto">
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea value={note} onChange={(e) => setNote(e.target.value)} onBlur={handleNoteSave} rows="4" className="w-full bg-gray-700 border border-gray-600 rounded-md p-2 mt-1 text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition" placeholder="Aggiungi una nota..."></textarea>
            </div>
          </div>
        </div>
